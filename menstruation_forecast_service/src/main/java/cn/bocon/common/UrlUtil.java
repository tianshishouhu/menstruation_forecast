...
import cn.bocon.service.impl.ExcelServiceImpl;
...
public class UrlUtil {
    ...
    public static void main(String[] args){
        System.out.println(getClassFilePath(ExcelServiceImpl.class));
        System.out.println(getClassPath(ExcelServiceImpl.class));
    }
