...
public class DateUtil {
     ...
     * @return long 返回值为：分
     */  
    public static long getMinDistanceTimes(String str1, String str2) {  
	...
	public static void main(String[] paramArrayOfString) {
		try {
			...
			//System.out.println(getMonthLastDay(2017, 5));
			long distanceTimes = getMinDistanceTimes("2017-10-27 08:01:00", "2017-10-27 08:07:00");
